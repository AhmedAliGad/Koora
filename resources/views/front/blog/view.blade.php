	...
	<div class="container">
		<div class="card box-shadow p-6">
			<h4 data-aos="zoom-in" data-aos-delay="300" class="has-text-gold mb-5">
				<i class="fa-regular fa-newspaper has-text-secondary is-size-5 ml-2"></i>
				5 ألقاب.. سيدات سلة الأهلى يحققن "العلامة الكاملة" ويحصدن كل البطولات
			</h4>
			<div class="card-image position-relative radius-15">
				<figure class="image blur radius-15">
					<lazy-load
				...
				<figure class="image non-blur" data-aos="zoom-in" data-aos-delay="300">
					<lazy-load
					src="/front/images/spinner.svg"
					lazy-src="/front/images/slide1.jpeg"
					lazy-srcset="/front/images/slide1.jpeg"
