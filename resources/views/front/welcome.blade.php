			...
			<div class="item p-2">
				<a class="box-shadow-sm" rel="noreferrer" href="">
					<figure>
						<lazy-load
						src="/front/images/spinner.svg"
						lazy-src="/front/images/5.png"
						lazy-srcset="/front/images/5.png"
						background-color="transparent"
						alt="title"
						/>
					</figure>
			...
			<div class="item p-2">
				<a class="box-shadow-sm" rel="noreferrer" href="">
					<figure>
						<lazy-load
						src="/front/images/spinner.svg"
						lazy-src="/front/images/6.png"
						lazy-srcset="/front/images/6.png"
						background-color="transparent"
						alt="title"
						/>
					</figure>
...
<!-----order---->
<section class="order-section py-6">
	<div class="section-padding position-relative">
		<div class="container">
			<div class="columns">
				<div class="column is-4">
					<div class="order-title has-background-gold has-text-light">
						<h4>الترتيب العام</h4>
					</div>
								...
								<div class="card px-2 py-5">
									<h4>
										...
										<p class="has-text-centered">
											<small class="has-text-grey-dark">عبدالله  محمود</small>
										</p>
									</h4>
									<div class="match">
										<a href="#">
